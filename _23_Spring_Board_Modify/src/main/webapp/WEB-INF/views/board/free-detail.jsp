        ...
        <main>
            ...
            <div class="container mt-3 w-50">
                <form id="modify-form" action="/board/modify.do" method="post">
                    ...
                    <!-- 객체 배열 형태의 originFiles 배열을 문자열로 input 에 담아서 전송 -->
                            ...
                            <div id="preview" class="mt-3 text-center"
                                ...
                                <c:forEach items="${fileList}" var="file" varStatus="status">
                                    <div class="upload-file-div">
                                        ...
                                        <!-- 밑에 표시된 파일을 클릭했을 때 파일 선택창이 뜨도록 input type="file" 생성 -->
                                        <input type="file" id="changeFile${file.id}" name="changeFile${file.id}" 
                                                style="display: none" onchange="changeFile(${file.id}, event)">
                                        ...
                                        <c:choose>
                                            <c:when test="${file.filetype eq 'image'}">
                                                <img id="img${file.id}"
                                                        ...
                                                        class="upload-file"  alt="${file.fileoriginname}"
                                        ...
                                        <input type="button" value="x"
                                                deleteFile="${file.id}"
                                                class="upload-file-delete-btn" onclick="deleteFile(event)">
    ...
    <script>
        ...
        $(() => {
            ...
            $("#uploadFiles").on("change", (e) => {
                ...
                // modify-form 이 submit 될 때 uploadFiles 배열에 담겨있는 파일들을 input name='uploadFiles' 에 담기
                ...
                $('#modify-form').on('submit', (e) => {
                    ...
                    $('#uploadFiles').files = dataTransfer2.files;
        ...
        const makeDiv = (img, file) => {
            ...
            btn.onclick = (e) => {
                ...
                // fileList 는 File 객체에 바로 담을 수 없기 때문에
                // DataTransfer 라는 클래스를 사용해서 변환 후에 담아줘야한다.
