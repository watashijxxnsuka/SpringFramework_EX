...
public class NoticeServiceRun {
    public static void main(String[] args) {
        ...
        noticeModifyDto.setId(5);
        noticeModifyDto.setTitle("공지사항 5번 수정");
        noticeModifyDto.setContent("공지사항 5번입니다.-수정");
        noticeModifyDto.setModdate(LocalDateTime.now());

        noticeBoardService.modify(noticeModifyDto);

        // 공지사항 삭제
        noticeBoardService.delete(12);
        ...
        // 특정 ID 공지사항 조회
        System.out.println(noticeBoardService.getBoard(5));
    }
}
