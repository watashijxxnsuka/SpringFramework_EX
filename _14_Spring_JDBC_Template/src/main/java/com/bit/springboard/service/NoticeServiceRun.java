...
public class NoticeServiceRun {
    public static void main(String[] args) {
        ...
        noticeModifyDto.setId(6);
        noticeModifyDto.setTitle("공지사항 6번 수정");
        noticeModifyDto.setContent("공지사항 6번입니다.-수정");
        noticeModifyDto.setModdate(LocalDateTime.now());

        noticeBoardService.modify(noticeModifyDto);

        // 공지사항 삭제
        noticeBoardService.delete(11);
        ...
        // 특정 ID 공지사항 조회
        System.out.println(noticeBoardService.getBoard(20));
    }
}
