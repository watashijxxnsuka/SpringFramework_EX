                                    ...
                                    <div class="upload-file-div">
                                        <c:choose>
                                            <c:when test="${file.filetype eq 'image'}">
                                                <img id="img${file.id}" src="/upload/${file.filename}" class="upload-file">
                                            </c:when>
                                            <c:otherwise>
                                                <img id="img${file.id}" src="/static/images/defaultFileImg.png" class="upload-file" alt="${file.fileoriginname}">
                                            </c:otherwise>
                                        </c:choose>
                                        <input type="button" value="x" deleteFile="${file.id}" class="upload-file-delete-btn">
